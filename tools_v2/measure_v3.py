...
DOCX = os.path.join(REPO, 'Ho_so_bai_giang_lai_xe_oto_2026_v3.docx')
PDF  = os.path.join(WORK, 'pdf', 'Ho_so_bai_giang_lai_xe_oto_2026_v3.pdf')
...
json.dump(out, open(os.path.join(WORK, 'toc_v3.json'), 'w', encoding='utf8'), ensure_ascii=False, indent=0)
